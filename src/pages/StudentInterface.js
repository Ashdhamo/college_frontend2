...
function StudentInterface() {
  ...
  const fetchStudentClasses = async (id) => {
    try {
      const response = await fetch(`http://127.0.0.1:8080/student/classes/${id}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        }
  ...
  const handleEnroll = async (classId) => {
    ...
    try {
      const response = await fetch('http://127.0.0.1:8080/student/enroll', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDrop = async (classId) => {
    ...
    try {
      const response = await fetch('http://127.0.0.1:8080/student/drop', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
