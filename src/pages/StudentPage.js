...
function StudentPage() {
  ...
  const searchStudents = async (query, years, major) => {
    ...
    try {
      ...
      const response = await fetch('http://127.0.0.1:8080/student/search', {
        method: 'POST',
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (modalMode === 'add') {
        response = await fetch('http://127.0.0.1:8080/student/add', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        response = await fetch(`http://127.0.0.1:8080/student/${currentStudent.id}`, {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
          },
