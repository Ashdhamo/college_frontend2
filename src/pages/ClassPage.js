...
function ClassPage() {
  ...
  const fetchProfessors = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/professor/search`, {
        method: 'POST',
        headers: {
  ...
  const searchClasses = async (query) => {
    setLoading(true);
    try {
      const response = await fetch(`${API_BASE_URL}/classes/search`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (modalMode === 'add') {
        response = await fetch(`${API_BASE_URL}/classes/add`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        response = await fetch(`${API_BASE_URL}/classes/${currentClass.class_id}`, {
          method: 'PATCH',
          headers: {
            'Content-Type': 'application/json',
          },
